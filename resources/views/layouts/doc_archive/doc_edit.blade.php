                    ...
                    <form action="{{ url('/document/update/'.$item-> id) }}" method="POST">
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="text" id="option1" class="form-control @error('no_surat') is-invalid @enderror" name="no_surat" value="{{ $item-> no_surat }}" />
                                @error('no_surat')
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="date" id="option2" class="form-control @error('tanggal') is-invalid @enderror"  name="tanggal" value="{{ $item-> tanggal }}"/>
                                @error('tanggal')
                                    <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="option4" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ $item-> judul }}" />
                            @error('judul')
                                <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                             @enderror
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="option5" class="form-control @error('link_file') is-invalid @enderror" name="link_file" value="{{ $item-> link_file }}"/>
                            @error('link_file')
                                <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                            @enderror
                        </div>
