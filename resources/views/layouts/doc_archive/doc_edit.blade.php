                    ...
                    <form action="{{ url('/document/update/'.$item-> id) }}" method="POST">
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="text" id="option1" class="form-control @error('no_surat') is-invalid @enderror" name="no_surat" value="{{ old('no_surat', $item-> no_surat) }}" />
                                @error('no_surat')
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="date" id="option2" class="form-control @error('tanggal') is-invalid @enderror"  name="tanggal" value="{{ old('tanggal', $item-> tanggal) }}"/>
                                @error('tanggal')
                                    <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <div class="btn-group @error('kategori') is-invalid @enderror">
                                    ...
                                    <input type="radio" class="btn-check" name="kategori" id="radio-option2" value="Produk Hukum" @if( $item-> kategori == 'Produk Hukum') checked @endif/>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="option4" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul', $item-> judul) }}" />
                            @error('judul')
                                <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                             @enderror
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="option5" class="form-control @error('link_file') is-invalid @enderror" name="link_file" value="{{ old('link_file', $item-> link_file) }}"/>
                            @error('link_file')
                                <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <textarea class="form-control @error('uraian') is-invalid @enderror" id="option6" rows="4" name="uraian">{{ old('uraian', $item-> uraian) }}</textarea>
                            @error('uraian')
                                    <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                            @enderror
                        </div>
