                  ...
                  <form action="{{ url('/infrastructure/add') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                              ...
                              <div class="form-outline col">
                                    ...
                                    <input type="text" id="option4" class="form-control @error('nama') is-invalid @enderror" name="nama" />
                                    @error('nama')
                                          <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                                    @enderror
                              </div>
                        ...
                        <div class="row mb-4">
                              <div class="col">
                                    <div class="form-outline">
                                          ...
                                          <input type="text" id="option1" class="form-control @error('tahun_pengadaan') is-invalid @enderror" name="tahun_pengadaan" />
                              ...
                              <div class="col">
                                    <div class="form-outline">
                                          ...
                                          <input type="text" id="option2" class="form-control @error('penyedia') is-invalid @enderror"  name="penyedia"/>
                                          @error('penyedia')
                                              <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                                          @enderror
                                    </div>
                              ...
                              <div class="col">
                                    <div class="form-outline">
                                          ...
                                          <input type="text" id="option1" class="form-control @error('lokasi') is-invalid @enderror" name="lokasi" />
                                          @error('lokasi')
                                              <div class="error fs-6 text-danger my-1">*{{ $message }}</div>
                                          @enderror
                                    </div>
                        ...
                        <div class="row mb-4">
                              ...
                              <div class="form-outline col">
                                    ...
                                    <input type="text" id="option4" class="form-control @error('latitude') is-invalid @enderror" name="latitude" />
                                    @error('latitude')
                              ...
                              <div class="form-outline col">
                                    ...
                                    <input type="text" id="option4" class="form-control @error('longitude') is-invalid @enderror" name="longitude" />
                                    @error('longitude')
                                        <div class="fs-6 error text-danger my-1">*{{ $message }}</div>
                                    @enderror
                              </div>
                        ...
                        <div class="row mb-4">
                              ...
                              <div class="form-outline col">
                                    ...
                                    <input type="file" id="option4" class="form-control @error('detail') is-invalid @enderror" name="detail" />
                                    @error('detail')
                                        <div class="fs-6 error text-danger my-1">*{{ $message }}</div>
                                    @enderror
                              </div>
